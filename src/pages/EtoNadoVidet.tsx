...
const episodes: Episode[] = [
  {
    ...
    date: '03.11.2025',
    videos: [
      { id: 1, title: 'Кот-музыкант играет на пианино', author: 'Мария Котова', description: 'Мой кот научился играть простые мелодии!', category: 'Питомцы', thumbnail: '🐱🎹', views: 45000, votes: 8500, isWinner: true },
      { id: 2, title: 'Экстремальный паркур в городе', author: 'Влад Прыгунов', description: 'Невероятные трюки на крышах', category: 'Спорт', thumbnail: '🏃‍♂️🏙️', views: 38000, votes: 7200 },
      { id: 3, title: 'Танец бабушки на свадьбе', author: 'Алёна Семёнова', description: 'Моя бабушка зажгла на свадьбе внучки!', category: 'Семья', thumbnail: '👵💃', views: 52000, votes: 6800 },
      { id: 4, title: 'Самодельный робот убирает квартиру', author: 'Игорь Технов', description: 'Собрал робота из подручных материалов', category: 'Технологии', thumbnail: '🤖🏠', views: 31000, votes: 5900 },
      { id: 5, title: 'Ребёнок поёт оперу', author: 'Ольга Певцова', description: 'Моему сыну 5 лет, а он поёт как профи!', category: 'Таланты', thumbnail: '👦🎤', views: 47000, votes: 5500 },
      { id: 6, title: 'Невероятный фокус с исчезновением', author: 'Денис Маг', description: 'Фокус, который удивит каждого!', category: 'Фокусы', thumbnail: '🎩✨', views: 29000, votes: 4800 },
      { id: 7, title: 'Собака спасает котёнка', author: 'Пётр Добрый', description: 'Наша собака спасла котёнка из воды', category: 'Питомцы', thumbnail: '🐕🐱', views: 61000, votes: 4500 },
      { id: 8, title: 'Рисую портрет за 60 секунд', author: 'Анна Художница', description: 'Скоростное рисование портретов', category: 'Искусство', thumbnail: '🎨👤', views: 25000, votes: 3900 },
      { id: 9, title: 'Готовлю торт без духовки', author: 'Лена Кулинар', description: 'Невероятный рецепт торта!', category: 'Кулинария', thumbnail: '🎂👩‍🍳', views: 33000, votes: 3600 },
      { id: 10, title: 'Приколы на работе', author: 'Команда офиса', description: 'Подборка смешных моментов', category: 'Юмор', thumbnail: '😂💼', views: 28000, votes: 3200 },
      { id: 11, title: 'Закат с дрона над морем', author: 'Сергей Пилот', description: 'Красивейшие кадры с высоты', category: 'Природа', thumbnail: '🌅🚁', views: 22000, votes: 2800 },
    ],
  },
  {
    id: 2,
    ...
    date: '04.11.2025',
    videos: [
      { id: 12, title: 'Попугай разговаривает фразами', author: 'Ирина Птичкина', description: 'Мой попугай говорит целыми предложениями!', category: 'Питомцы', thumbnail: '🦜💬', views: 56000, votes: 9200, isWinner: true },
      { id: 13, title: 'BMX трюки для новичков', author: 'Максим Велик', description: 'Учу простым трюкам на BMX', category: 'Спорт', thumbnail: '🚴‍♂️⭐', views: 34000, votes: 6700 },
      { id: 14, title: 'Папа делает причёски дочке', author: 'Андрей Папочка', description: 'Папа справляется лучше мамы!', category: 'Семья', thumbnail: '👨‍👧💇', views: 48000, votes: 6400 },
      { id: 15, title: 'Умный дом своими руками', author: 'Виктор Техник', description: 'Автоматизация квартиры за копейки', category: 'Технологии', thumbnail: '🏡🔧', views: 39000, votes: 5800 },
      { id: 16, title: 'Девочка танцует балет', author: 'Светлана Мама', description: 'Первое выступление дочки', category: 'Таланты', thumbnail: '👧🩰', views: 41000, votes: 5300 },
      { id: 17, title: 'Карточные фокусы мастера', author: 'Артём Карты', description: 'Профессиональные трюки с картами', category: 'Фокусы', thumbnail: '🃏✨', views: 27000, votes: 4600 },
      { id: 18, title: 'Хомяк проходит лабиринт', author: 'Катя Хомячок', description: 'Построила лабиринт для хомяка', category: 'Питомцы', thumbnail: '🐹🎯', views: 44000, votes: 4200 },
      { id: 19, title: 'Граффити за 5 минут', author: 'Саша Стрит', description: 'Быстрое создание граффити', category: 'Искусство', thumbnail: '🎨🖌️', views: 31000, votes: 3800 },
      { id: 20, title: 'Десерт из 3 ингредиентов', author: 'Юля Сладкая', description: 'Простейший рецепт вкусняшки', category: 'Кулинария', thumbnail: '🍰✨', views: 36000, votes: 3500 },
      { id: 21, title: 'Неудачи на тренировках', author: 'Спортзал №5', description: 'Смешные моменты в зале', category: 'Юмор', thumbnail: '😅💪', views: 29000, votes: 3100 },
      { id: 22, title: 'Северное сияние в 4K', author: 'Николай Север', description: 'Снял сияние в Мурманске', category: 'Природа', thumbnail: '🌌✨', views: 25000, votes: 2900 },
    ],
  },
  {
    id: 3,
    ...
    date: '05.11.2025',
    videos: [
      { id: 23, title: 'Малыш делает первые шаги', author: 'Елена Мамочка', description: 'Самый трогательный момент!', category: 'Семья', thumbnail: '👶👣', views: 68000, votes: 10500, isWinner: true },
      { id: 24, title: 'Скейтборд-трюки в парке', author: 'Олег Скейтер', description: 'Новые трюки на скейте', category: 'Спорт', thumbnail: '🛹🔥', views: 42000, votes: 7800 },
      { id: 25, title: 'Дедушка учится TikTok', author: 'Семья Ивановых', description: 'Деду 75, а он в тренде!', category: 'Семья', thumbnail: '👴📱', views: 55000, votes: 7100 },
      { id: 26, title: '3D-принтер печатает игрушки', author: 'Дмитрий 3D', description: 'Печатаю игрушки для детей', category: 'Технологии', thumbnail: '🖨️🎁', views: 37000, votes: 6200 },
      { id: 27, title: 'Мальчик играет на барабанах', author: 'Рок-семья', description: 'Ему 7 лет, а играет как профи!', category: 'Таланты', thumbnail: '👦🥁', views: 46000, votes: 5900 },
      { id: 28, title: 'Левитация с помощью магнитов', author: 'Илья Физик', description: 'Научный эксперимент дома', category: 'Фокусы', thumbnail: '🧲✨', views: 32000, votes: 5100 },
      { id: 29, title: 'Кролик играет в футбол', author: 'Миша Ушастик', description: 'Мой кролик - футболист!', category: 'Питомцы', thumbnail: '🐰⚽', views: 49000, votes: 4700 },
      { id: 30, title: 'Рисую песком на стекле', author: 'Вера Песочница', description: 'Искусство рисования песком', category: 'Искусство', thumbnail: '🏖️🎨', views: 28000, votes: 4100 },
      { id: 31, title: 'Блины с начинкой: 5 видов', author: 'Таня Блинчик', description: 'Секреты идеальных блинов', category: 'Кулинария', thumbnail: '🥞😋', views: 40000, votes: 3900 },
      { id: 32, title: 'Кот vs огурец', author: 'Смешные моменты', description: 'Реакция котов на огурцы', category: 'Юмор', thumbnail: '😹🥒', views: 51000, votes: 3400 },
      { id: 33, title: 'Водопад в горах', author: 'Путешественник Коля', description: 'Красота Кавказа', category: 'Природа', thumbnail: '💧🏔️', views: 24000, votes: 3000 },
    ],
  },
];
