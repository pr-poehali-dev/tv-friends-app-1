  ...
  const episodes: Episode[] = [
    {
      ...
      date: '15 января 2024',
      duration: '52 мин',
      description: 'Первый выпуск международного проекта! Город двух континентов. Айя-София, Голубая мечеть и Гранд-базар. Турецкий завтрак, балык-экмек и круиз по Босфору.',
    ...
    },
    {
      ...
      date: '4 марта 2024',
      duration: '51 мин',
      description: 'Термальные купальни, Рыбацкий бастион и круиз по Дунаю. Венгерский гуляш, лангош и токайское вино.',
      thumbnail: 'https://cdn.poehali.dev/projects/3478e400-ff84-4126-9411-8f9e5adbc820/files/882ccc88-2d7b-43fc-a77a-df961c88135e.jpg',
      isInternational: true,
      rating: 5.0,
    },
    {
      ...
      date: '11 марта 2024',
      duration: '50 мин',
      description: 'Каналы, велосипеды и музеи Рембрандта и Ван Гога. Тюльпаны, голландские сыры и панкейки. Атмосфера свободы и толерантности.',
      thumbnail: 'https://cdn.poehali.dev/projects/3478e400-ff84-4126-9411-8f9e5adbc820/files/882ccc88-2d7b-43fc-a77a-df961c88135e.jpg',
      isInternational: true,
      rating: 4.8,
    },
    {
      ...
      season: 1,
      episode: 10,
      title: 'Столица на Шпрее',
      city: 'Берлин',
      country: 'Германия',
      date: '18 марта 2024',
      duration: '60 мин',
      description: 'Финал первого сезона! Бранденбургские ворота, остатки Берлинской стены и музейный остров. Немецкие сосиски, пиво и уличное искусство. История и современность.',
      thumbnail: 'https://cdn.poehali.dev/projects/3478e400-ff84-4126-9411-8f9e5adbc820/files/882ccc88-2d7b-43fc-a77a-df961c88135e.jpg',
      isInternational: true,
      rating: 5.0,
    },
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto text-center mb-12">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8">
              ...
              10 городов Европы — путешествие по самым красивым столицам мира.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="mb-12">
              ...
              <p className="text-muted-foreground text-center mb-8">
                10 выпусков — путешествие по самым красивым городам Европы
              </p>
            </div>
