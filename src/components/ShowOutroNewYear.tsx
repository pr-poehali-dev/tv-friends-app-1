...
interface ShowOutroNewYearProps {
  onComplete?: () => void;
}

const ShowOutroNewYear = ({ onComplete }: ShowOutroNewYearProps) => {
  ...
  useEffect(() => {
    ...
    const sceneTimings = [3500, 3500, 3500, 4000];
          ...
          <div className="text-center space-y-8 relative">
            ...
            <div className="relative">
              ...
              <div className="relative bg-white/20 backdrop-blur-xl rounded-3xl p-12 border-4 border-white/50 shadow-2xl">
                ...
                <h2 className="text-8xl font-black text-white tracking-tight mb-8 drop-shadow-lg">
                  ВИДЕТЬ!
                </h2>
                
                <div className="border-t-2 border-white/50 pt-6 mt-6 space-y-3">
                  <p className="text-white text-lg font-semibold">Производство:</p>
                  <p className="text-white text-3xl font-bold tracking-wide drop-shadow-lg">МАСТИФФ</p>
                  <p className="text-white/90 text-base">по заказу</p>
                  <p className="text-white text-2xl font-bold drop-shadow-lg">АО Телеканал "Новые друзья ТВ"</p>
                  <p className="text-white/80 text-xl font-semibold mt-4">© 2025</p>
...
export default ShowOutroNewYear;
