...
interface ShowOutroProps {
  onComplete?: () => void;
}

const ShowOutro = ({ onComplete }: ShowOutroProps) => {
          ...
          <div className="text-center space-y-8">
            <div className="relative">
              ...
              <div className="relative bg-white/10 backdrop-blur-xl rounded-3xl p-12 border-4 border-white/30 shadow-2xl">
                ...
                <h2 className="text-8xl font-black text-white tracking-tight mb-8">
                  ВИДЕТЬ!
                </h2>
                
                <div className="border-t-2 border-white/30 pt-6 mt-6 space-y-3">
                  <p className="text-white text-lg font-semibold">Производство:</p>
                  <p className="text-white text-3xl font-bold tracking-wide">МАСТИФФ</p>
                  <p className="text-white/90 text-base">по заказу</p>
                  <p className="text-white text-2xl font-bold">АО Телеканал "Новые друзья ТВ"</p>
